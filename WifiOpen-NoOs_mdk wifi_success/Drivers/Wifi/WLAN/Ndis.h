...
#ifndef __WIFI_NDIS_H__
#define __WIFI_NDIS_H__
//
// Macros definitions
//
...
typedef BOOL NDIS_STATUS, *PNDIS_STATUS; // note default size
typedef DWORD NDIS_PHYSICAL_ADDRESS, *PNDIS_PHYSICAL_ADDRESS;
